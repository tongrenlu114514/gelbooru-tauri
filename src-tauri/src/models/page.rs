...
mod tests {
    ...
    fn gelbooru_page_with_posts() {
        ...
        page.post_list.push(GelbooruPost::new(1, "url1".to_string(), "post1".to_string()));
        page.post_list.push(GelbooruPost::new(2, "url2".to_string(), "post2".to_string()));
    ...
    fn gelbooru_page_with_tag_list() {
        ...
        page.tag_list.push(GelbooruTag::new("artist_tag".to_string(), "artist".to_string(), 100));
    ...
    fn gelbooru_page_various_page_numbers(
        #[case] tags: Vec<&str>,
        #[case] page_num: u32,
    ) {

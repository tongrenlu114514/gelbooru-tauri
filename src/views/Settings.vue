  ...
  <div class="settings-view">
    ...
    <n-form label-placement="left" label-width="120px" style="margin-top: 20px; max-width: 500px">
      <n-form-item label="深色模式">
        <n-switch :value="theme === 'dark'" @update:value="settingsStore.toggleTheme" />
      </n-form-item>
      ...
      <n-form-item label="并发下载数">
        <n-input-number v-model:value="concurrentDownloads" :min="1" :max="10" />
      </n-form-item>
      ...
      <n-form-item label="代理地址" v-if="proxyEnabled">
        <n-grid :cols="2" :x-gap="12">
          <n-gi>
            <n-input v-model:value="proxyHost" placeholder="127.0.0.1" />
          </n-gi>
          <n-gi>
            <n-input-number
